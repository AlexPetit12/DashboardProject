...
class YahooFinance:
    def __init__(self):
        self.url = 'https://uk.finance.yahoo.com/quote/AAPL/history'
        self.token = self.get_token()

    def get_symbol_data(self, symbol, start_date=(2000, 1, 1), end_date=None):
    ...
    def get_symbol_data_today(self, symbol):
        datetime_today = pd.datetime.today()
        today = (datetime_today.year, datetime_today.month, datetime_today.day)
        return self.get_symbol_data(symbol, start_date=today, end_date=today)
